...
export const searchProduct = createAsyncThunk(
  ...
  async (paramaters: {
    ...
    return {
      data: response.data,
      pagination: JSON.parse('response.headers["x-pagination"]'), // 在header中是字串的方式, 所以必須改成物件
    }
  }
)
...
// 在createSlice中 只能使用extraReducer才能使用ThunkAction所對應的字段padding, fulfilled rejected
